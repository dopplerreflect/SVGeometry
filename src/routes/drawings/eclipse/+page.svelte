...
<DopplerSvg {id} {size}>
	<defs>
		<linearGradient id="ECLIPSE-lg">
			<stop offset="0%" stop-color="oklch(0 25% 60 / 0.05)" />
			<stop offset="40%" stop-color="oklch(1 25% 60 / 0.15)" />
			<stop offset="100%" stop-color="oklch(0 25% 60 / 0.05)" />
		</linearGradient>
	...
	<circle
		r={r - 2.5}
		style={`fill:oklch(0 0 0 / 1);stroke:oklch(1 15% 60 / 2);stroke-width:5;`}
